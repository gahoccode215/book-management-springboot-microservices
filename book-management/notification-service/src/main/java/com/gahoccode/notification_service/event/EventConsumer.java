package com.gahoccode.notification_service.event;

import com.gahoccode.common_service.service.EmailService;
...
public class EventConsumer {
    ...
    public void testEmail(String message){
        ...
        String template = "<div>\n" +
                ...
                "</div>";
        String filledTemplate = String.format(template, "Minh Do", message);
